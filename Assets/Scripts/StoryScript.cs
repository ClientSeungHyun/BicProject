...
public class StoryScript : MonoBehaviour
{
    ...
    "그럼 화려하게 날뛰고 와!!!", ".........","무기는 어디 있냐고?", "옆쪽에 있는 버튼을 누르면 무기가 소환되도록 해뒀어!!",
    "...무슨 소리냐고?? 저쪽에서 알테니까 신경쓰지 말고!!","그 외에도 다양한 능력이 있으니 찾아서 실험해보도록!!", "고물 덩어리 놈들이 몰려오기 전에 준비를 끝내두고!", "그럼 행운을 빌게!"};

    public string[] stage02Script = {"역시 첫 번째 구역은 간단하게 해결했구나!!", "도시 탈환 계획은 아주 순조로운걸?!",
    "너의 침입을 눈치 챘는지 이번에 더 많은 기체를 보내오기 시작했어...","이번에도 행운을 빌게..."};

    public string[] stage03Script = {"수고했어!!", "생각보다 빨리 등장했지만 고물덩어리들을 조종하는 개체, 우두머리가 나올거야....",
    "인간의 형태를 띄고 있지만 우리를 따라했을 뿐", "하지만 신체능력은 너와 비교해도 손색이 없는 괴물자식이지.",
    "저놈만 물리치면 끝이라고 봐도 돼", "아무리 너라도 힘든 싸움이 되겠지만....", "너라면 가능할 거라고 믿어!!"};
